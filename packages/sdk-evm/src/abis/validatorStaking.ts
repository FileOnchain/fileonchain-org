/**
 * ABI for contracts/evm/src/ValidatorStaking.sol — generated from the Foundry build
...
export const validatorStakingAbi = [
  ...
  {
    "type": "function",
    "name": "setUnbondingSeconds",
    "inputs": [
      {
        "name": "newUnbondingSeconds",
        "type": "uint64",
        "internalType": "uint64"
      }
    ],
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ValidatorStaking.StakeInfo",
        "components": [
          {
            "name": "amount",
            "type": "uint256",
