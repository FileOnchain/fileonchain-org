...
/**
 * Aptos sender — sequential `file_registry::anchor_cid` module calls through
 * Petra / Martian. Provisioning is checked before any wallet interaction, so
 * until a module address lands in the SDK chain registry this throws
