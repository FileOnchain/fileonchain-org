...
/**
 * Starknet sender — `anchor_cid` multicalls on the Cairo FileRegistry through
 * Argent X / Braavos. Starknet accounts execute multicalls natively, so all
 * calls in a batch cost one wallet approval.
 */
